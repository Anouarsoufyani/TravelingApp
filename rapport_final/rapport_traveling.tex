...
\begin{tabularx}{\textwidth}{>{\bfseries}l X}
  ...
  Firebase Auth + Firestore
    & Authentification email/password et synchronisation cloud des données sociales
      ...
      temps réel. Plan Spark gratuit — aucune carte bancaire requise. \\
  Room (SQLite local)
    & Les données personnelles (groupes, chat, parcours, préférences) sont stockées
      localement. Room offre la sécurité de type, les LiveData automatiques,
      et fonctionne sans connexion réseau. \\
